...
class MainMenu
{
  ...
  {
    System.out.println("\t\t*******************************************");
    System.out.println("\t\t\t EMS using Singly Linked List ");
    System.out.println("\t\t*******************************************");
    System.out.println("\t\t\t    --------------------");
    System.out.println("\t\t\t     ~$ Sufiyaan Rahi");
    System.out.println("\t\t\t    --------------------");
    System.out.println("\n\nPress 1 : To Insert Employee Data");
    System.out.println("Press 2 : To Search Employee Data ");
    System.out.println("Press 3 : To Delete Employee Data");
    System.out.println("Press 4 : To Modify Employee Data");
